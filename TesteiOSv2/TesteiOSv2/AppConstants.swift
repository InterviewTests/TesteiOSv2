...
let API_URL_STATEMENT : String = "/statements/"

let MOVIE_DATE_FORMATTER = "dd/MM/YYYY"
let LOGIN_ERROR_TITTLE_USERNAME : String = "Usuário Incorreto"
let LOGIN_ERROR_TITTLE_PASSWORD : String = "Senha Incorreta"
