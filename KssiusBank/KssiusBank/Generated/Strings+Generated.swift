  ...
  internal enum User {
    internal enum Authentication {
      internal enum Error {
        ...
        internal static let invalidPassword = L10n.tr("Localizable", "user.authentication.error.invalidPassword", fallback: "Por favor informe uma senha que contenha pelo menos uma letra maiúscula, um caracter especial e um caracter alfanumérico.")
      }
    }
  }
}
